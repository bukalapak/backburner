...
module Backburner
  ...
  class Worker
    ...
    def work_one_job(conn = connection)
      ...
      e = Backburner::Job::DroppedJobError.new(e) if job&.stats&.buries.to_i >= queue_config.max_job_buries
      self.log_error self.exception_message(e)
      ...
      elsif job.stats.buries >= queue_config.max_job_buries # too many buries, drop the job
        job.drop(e)
